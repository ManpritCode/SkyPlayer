package com.rahul.musicapp.fragments;
...
import com.rahul.musicapp.CurrentSongHelper;
import com.stevenmwesigwa.musicapp.R;
import com.rahul.musicapp.Songs;
import com.rahul.musicapp.databases.EchoDatabase;
...
public class SongPlayingFragment extends Fragment {
    ...
    private BlastVisualizer  blastVisualizer = null ;
    ...
    private void changeFavoriteIconNowPlaying() {
        ...
        if (echoDatabaseFavorite.ifSongIdExists(currentSongHelper.getSongId().intValue())) {
            favoriteIconNowPlaying.setImageDrawable(ContextCompat.getDrawable(getActivity(), R.drawable.favourite_on));
        } else {
            favoriteIconNowPlaying.setImageDrawable(ContextCompat.getDrawable(getActivity(), R.drawable.favourite_off));
        }
    ...
    private void updateSeekBarStartEndTime(MediaPlayer mediaPlayer) {
        ...
        int startTime = seekBarNowPlaying.getProgress();

        startTimeSeekBarNowPlaying.setText(convertDuration(startTime));
        seekBarNowPlaying.setProgress(0);

        endTimeSeekBarNowPlaying.setText(convertDuration(finalTime));
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                String n = convertDuration(mediaPlayer.getCurrentPosition());
                startTimeSeekBarNowPlaying.setText(n);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        blastVisualizer = view.findViewById(R.id.blast);
...
//
    ...
    */
        ...
        favoriteIconNowPlaying.setOnClickListener(
                ...
                view -> {
                    ...
                    if (echoDatabaseFavorite.ifSongIdExists(songId)) {
                        ...
                        favoriteIconNowPlaying.setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.favourite_off));
                        echoDatabaseFavorite.delete(songId);
                        Toast.makeText(getActivity(), "Removed from Favorites List", Toast.LENGTH_SHORT).show();
                    } else {
                        favoriteIconNowPlaying.setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.favourite_on));
    ...
    public String convertDuration(int duration) {
        ...
        if(sec < 10) timelabel = timelabel + "0";
